        ...
        <div class="container-fluid py-2">
            <div class="row">
                <div class="ms-3">
                    ...
                    <p class="mb-4">
                        Overview of hospital statistics and recent activity.
                    </p>
                </div>
                                    ...
                                    <tbody>
                                        @foreach($recentPatients as $patient)
                                            <tr>
                                                ...
                                                <a href="{{ route('patient.show', $patient->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="View patient">
                                                    View
                                                </a>
                                                </td>
                                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="me-2 text-xs font-weight-bold">{{ $service->patients_count }}</span>
                                                    <div>
                                                        <div class="progress">
                                                            <div class="progress-bar bg-gradient-info" role="progressbar" 
                                                                aria-valuenow="{{ $service->patients_count }}" aria-valuemin="0" 
                                                                style="width: {{ min(100, $service->patients_count * 5) }}%"></div>
                                        </div>
                                </div>
                                        </div>
                                            </td>
                                            <td class="align-middle">
                                                <a href="{{ route('services.edit', $service->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit service">
                                                    Edit
                                                </a>
                                            </td>
                                        </tr>
