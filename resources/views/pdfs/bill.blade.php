...
<head>
    ...
    <title>Bill #{{ $bill->bill_number }} - {{ $tenant ? $tenant->name : 'HospiBill' }}</title>
    <style>
        @page {
            size: A4;
...
<body>
    <div class="content">
        <div class="header">
            ...
            <p>{{ $tenant ? $tenant->address : '123 Hospital Street, Medical City, 12345' }}</p>
            <p>Phone: {{ $tenant ? $tenant->phone_number : '(123) 456-7890' }} | Email: {{ $cashier ? $cashier->email : 'billing@' . $domain }}</p>
        </div>
        ...
        <div class="payment-info">
            ...
            <ul>
                ...
                <li>Bank transfer to Account #: {{ $tenant ? $tenant->bank_account : '1234-5678-9012' }}</li>
                <li>Online payment through our patient portal</li>
            </ul>
            <p>For any questions regarding this bill, please contact our billing department at {{ $cashier ? $cashier->email : 'billing@' . $domain }} or call {{ $tenant ? $tenant->phone_number : '(123) 456-7890' }}.</p>
        </div>
    </div>
    
    <div class="footer">
        <p>Thank you for choosing {{ $tenant ? $tenant->name : 'HospiBill' }} for your healthcare needs.</p>
